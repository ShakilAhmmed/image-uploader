                        ...
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="name" v-model="user.name" id="name" placeholder="Enter name"
                                       class="form-control">
                                <span class="text-danger" v-text="errors.name && errors.name[0]"></span>
                            </div>
                            <div class="form-group col-12">
                                <label for="email" class="font-weight-bold">Email</label>
                                <input type="text" name="email" v-model="user.email" id="email"
                                       placeholder="Enter Email" class="form-control">
                                <span class="text-danger" v-text="errors.email && errors.email[0]"></span>
                            </div>
                            <div class="form-group col-12">
                                <label for="password" class="font-weight-bold">Password</label>
                                <input type="password" name="password" v-model="user.password" id="password"
                                       placeholder="Enter Password" class="form-control">
                                <span class="text-danger" v-text="errors.password && errors.password[0]"></span>
                            </div>
                            <div class="form-group col-12">
                                ...
                                <input type="password_confirmation" name="password_confirmation"
                                       ...
                                       placeholder="Enter Password" class="form-control">
                                <span class="text-danger" v-text="errors.password && errors.password[1]"></span>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async register() {
            ...
            this.errors = [];
            await axios.post('/api/v1/auth/register', this.user)
                .then(response => {
                    this.signIn()
                })
                .catch(error => {
